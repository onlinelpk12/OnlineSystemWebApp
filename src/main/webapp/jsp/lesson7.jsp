...
<body>
        ...
        <div class="row">
            ...
            <ul>
               		...
               		<ul>
               			...
               			<ul>
               				<li>Here in the relation protonsOf(E, N) E indicates the first letter where as N indicates the protron number of element </li>
						<ul>
					...
					<div id="correctAnswerComment"></div>
               		...
               		<div id="factAssessmentHydrogen" class="form-group">
					  <input id="fact" type="text" class="form-control" required></div>
					<div id="correctAnswerFact"></div>
               </ul>
               		</ul>
               		</ul>                		
    ...
    <section id="version-1-course-x-lesson-7-page-28" class="container" hidden>
        <div class="row">
            ...
            <a class="btn btn-primary pull-right"
                onclick="gotoNext(7, 4, 'version-1-course-x-lesson-7-page-28', false, -1)"> Next </a>
                #image no lesson7picture8
            </div>
        </div>  
    </section>
